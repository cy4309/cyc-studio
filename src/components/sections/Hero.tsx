  ...
  return (
    <section className="hero-section h-dvh relative flex justify-center items-center overflow-hidden">
      ...
      >
        ...
        <p className="md:text-lg tracking-wide text-primary max-w-2xl mx-auto">
      ...
      <motion.h1
        className="absolute inset-0 flex justify-center items-center text-4xl md:text-6xl tracking-wider text-primary font-bold pointer-events-none"
        initial={{ opacity: 0 }}
        animate={{
          opacity: [0, 1, 1, 0],
